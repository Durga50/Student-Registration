...
<body>
 ...
 <div class="header">
  ...
  <div class="header-right">
    ...
    <a href="New_Course.html" style="color:white" class="active">Add Student</a>
...
$kk=$_POST['kk'];
$dk=$_POST['dk'];
$sql="insert into details(NAME,NUMBER,ADDRESS) values('$aa','$kk','$dk')";
$res=$conn->query($sql);
if($res==TRUE)
{
    echo '<br><h2 color="white" align="center">Data insertion Success...</h2>';
}
else
{
    echo 'Error...';
